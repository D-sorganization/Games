...
class Raycaster:
    ...
    def __init__(self, game_map: Map):
        ...
        # Optimization: Single reusable surfaces for vertical strips shading/fog
        # Using set_alpha on a solid surface is faster than fill() with alpha
                    ...
                    if scaled_strip:
                        try:
                            ...
                            if shade < 1.0:
                                ...
                                if alpha > 0:
                                    # Use optimized set_alpha + blit with shared surface
                                    # This avoids expensive fill() calls per ray
