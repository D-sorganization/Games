...
# Rendering Shade/Gradient Constants
MAX_SHADE_LEVELS = 20.0
GRADIENT_BAND_HEIGHT = 10
SKY_GRADIENT_OFFSET = 30
FLOOR_GRADIENT_OFFSET = 40

# Minigun Specifics
MINIGUN_BULLETS_PER_SHOT = 3
MINIGUN_SPREAD = 0.15
MINIGUN_PROJECTILE_SPEED = 2.0
MINIGUN_PROJECTILE_SIZE = 0.1
MINIGUN_MUZZLE_FLASH_PARTICLES = 8
