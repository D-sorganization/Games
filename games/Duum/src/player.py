...
class Player:
    ...
    def shoot(self) -> bool:
        ...
        if self.current_weapon == "minigun":
            spin_up = weapon_data.get("spin_up_time", 30)
    ...
    def get_current_weapon_damage(self) -> int:
        ...
        return C.WEAPONS[self.current_weapon]["damage"]

    def get_current_weapon_range(self) -> int:
        """Get range of current weapon"""
        return C.WEAPONS[self.current_weapon]["range"]
        ...
        for w_name, w_state in self.weapon_state.items():
            ...
            if w_name == "plasma":
                ...
                if w_state["overheated"]:
                    ...
                    penalty_time = w_data.get("overheat_penalty", 180)
                    max_heat = w_data["max_heat"]
