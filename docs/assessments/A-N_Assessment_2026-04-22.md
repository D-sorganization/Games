# A-N Assessment - Games - 2026-04-22

Run time: 2026-04-22T08:02:52.5783419Z UTC
Sync status: synced
Sync notes: Already up to date.
From https://github.com/D-sorganization/Games
...
- Reviewed 779 tracked files, including 384 code files, 153 test files, 34 CI files, 7 config/build files, and 128 docs/onboarding files.
...
- Evidence: `779 tracked first-party files`
- Evidence: `481 files under source-like directories`
...
- Evidence: `scripts/assessment_modules.py`
...
- Evidence: `scripts/mypy_fixers.py`
...
- Evidence: `scripts/analyze_completist_data.py (517 lines)`
- Evidence: `src/games/Force_Field/src/bot.py (525 lines)`
- Evidence: `src/games/Force_Field/src/gameplay_runtime.py (501 lines)`
- Evidence: `src/games/Force_Field/src/weapon_renderer.py (555 lines)`
- Evidence: `src/games/Peanut_Butter_Panic/peanut_butter_panic/core.py (560 lines)`
- Evidence: `src/games/QuatGolf/src/main.cpp (835 lines)`
...
- Evidence: `src/games/shared/game_state_types.py (coarse avg 83 lines/definition)`
...
- Evidence: `.github/workflows/Jules-Code-Quality-Reviewer.yml`
- Evidence: `.github/workflows/Jules-Completist.yml`
...
- Evidence: `src/games/Force_Field/src/combat_system_explosions.py`
...
- Severity: medium
- Problem: Oversized files found: conftest.py (524 lines); scripts/analyze_completist_data.py (517 lines); src/games/Force_Field/src/bot.py (525 lines); src/games/Force_Field/src/gameplay_runtime.py (501 lines); src/games/Force_Field/src/weapon_renderer.py (555 lines); src/games/Peanut_Butter_Panic/peanut_butter_panic/core.py (560 lines); src/games/QuatGolf/src/main.cpp (835 lines); src/games/shared/cpp/tests/test_core_game_ai.cpp (727 lines); src/games/shared/cpp/tests/test_loaders.cpp (866 lines); src/games/shared/fps_game_base.py (571 lines); src/games/shared/raycaster.py (584 lines); tests/QuatGolf/cpp/test_quatgolf.cpp (561 lines); tests/shared/cpp/test_math.cpp (540 lines); tests/shared/test_combat_manager.py (670 lines); tests/shared/test_player_base.py (698 lines); tests/shared/test_raycaster.py (716 lines); tests/tetris/test_tetris_comprehensive.py (657 lines)
...
- Severity: medium
- Problem: Deep member-chain hints found in: create_desktop_shortcut.ps1; src/games/Duum/tests/test_bot.py; src/games/Duum/tests/test_entity_manager.py; src/games/Duum/tests/test_particle_system.py; src/games/Duum/tests/test_player.py; src/games/Duum/tests/test_renderer.py; src/games/Force_Field/src/combat_system.py; src/games/Force_Field/src/combat_system_explosions.py
