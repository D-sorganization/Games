...
inline const Club CLUBS[] = {
    {"Driver", 10.5f, 73.0f, 50.0f, 1},  {"3 Wood", 15.0f, 67.0f, 60.0f, 2},
    {"5 Iron", 27.0f, 56.0f, 90.0f, 3},  {"7 Iron", 34.0f, 49.0f, 110.0f, 4},
    {"9 Iron", 41.0f, 42.0f, 130.0f, 5}, {"PW", 46.0f, 38.0f, 140.0f, 6},
    {"SW", 56.0f, 30.0f, 150.0f, 7},     {"LW", 60.0f, 25.0f, 160.0f, 8},
