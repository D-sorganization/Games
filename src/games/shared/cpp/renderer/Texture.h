...
class Texture {
 public:
  ...
  void upload(const std::vector<uint8_t>& pixels, int w, int h) {
    ...
    gl::glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, w, h, 0, GL_RGBA, GL_UNSIGNED_BYTE, pixels.data());
  ...
  static Texture create_checkerboard(int size = 256, int squares = 8, uint8_t r1 = 200,
                                     uint8_t g1 = 200, uint8_t b1 = 200, uint8_t r2 = 60,
                                     uint8_t g2 = 60, uint8_t b2 = 60) {
    Texture tex;
  ...
  static Texture create_gradient(int size = 256, uint8_t r_top = 5, uint8_t g_top = 5,
                                 uint8_t b_top = 30, uint8_t r_bot = 40, uint8_t g_bot = 20,
                                 uint8_t b_bot = 60) {
    Texture tex;
    std::vector<uint8_t> pixels(size * size * 4);
