...
def gen_pistol():
    ...
    with wave.open(filename, 'w') as f:
        ...
        for i in range(n_frames):
            ...
            val = int(0.5 * 32767 * (noise * 0.7 + tone * 0.3))
...
def gen_shotgun():
    ...
    with wave.open(filename, 'w') as f:
        ...
        for i in range(n_frames):
            ...
            val = int(0.6 * 32767 * (noise * 0.6 + boom * 0.4))
            f.writeframes(struct.pack('h', val))
gen_shotgun()
...
def gen_plasma():
    ...
    with wave.open(filename, 'w') as f:
        ...
        for i in range(n_frames):
            ...
            f.writeframes(struct.pack('h', int(0.4 * 32767 * val)))
gen_plasma()
